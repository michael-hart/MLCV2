...
An example of an estimated homography matrix is given in Equation TODO, where the images used in Figure \ref{fig:manual} were again used to estimate a transformation. The result of transforming Image A to fit Image B
