%% Question 2 Part 2 Section C 1 Epipolar Lines FD
clear;
close all;
if ismac
    addpath('../res/kitchen');
...
print([outputpath, 'pic/q2_2_c3_A'],'-dpng','-r0');
...
fig = gcf;
fig.PaperPositionMode = 'auto';
print([outputpath, 'pic/q2_2_c3_dis'],'-dpng','-r0');
...
fig = gcf;
fig.PaperPositionMode = 'auto';
print([outputpath, 'pic/q2_2_c3_depth'],'-dpng','-r0');